            ...
            <div className="footer-container container">
                ...
                <div className="footer-top">
                    ...
                    <div className="footer-socials">
                        <a href="https://wa.me/yournumber" className="social-icon" target="_blank" rel="noreferrer" aria-label="WhatsApp">
                        ...
                        <a href="https://instagram.com/beautyverse" className="social-icon" target="_blank" rel="noreferrer" aria-label="Instagram">
                        ...
                        <a href="https://x.com/beautyverse" className="social-icon" target="_blank" rel="noreferrer" aria-label="X">
                ...
                <div className="footer-bottom">
                    <div className="footer-copyright">
                        &copy; 2025 Powered by <span>BeautyVerse</span>
                    </div>
                </div>
            </div>
        </footer>
