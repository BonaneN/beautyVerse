        ...
        <nav className="sticky top-0 z-[1000] h-20 bg-white shadow-soft">
            <div className="h-full px-8 flex items-center justify-between gap-4">
                ...
                <div className="flex-none w-1/4">
                    <Link to="/" className="font-heading text-3xl font-bold text-night-bordeaux whitespace-nowrap">
                ...
                <div className="hidden lg:flex flex-1 justify-center items-center gap-12">
                    ...
                    <div className="flex items-center gap-6 pl-12 border-l border-soft-apricot">
